 ...
 * Update URI:        https://github.com/HalloftheGods/xophz-compass-bugnet
 */
 ...
 */
define( 'XOPHZ_COMPASS_BUGNET_VERSION', '26.9.4-165' );
...
function deactivate_xophz_compass_bugnet() {
	Xophz_Compass_Bugnet::deactivate();
}
...
add_action( 'plugins_loaded', 'run_xophz_compass_bugnet' );

function xophz_compass_bugnet_action_links( $links ) {
  $settings_link = '<a href="edit.php?post_type=compass_bug&page=bugnet-github-settings">' . __( 'Settings', 'xophz-compass-bugnet' ) . '</a>';
...
add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), 'xophz_compass_bugnet_action_links' );
